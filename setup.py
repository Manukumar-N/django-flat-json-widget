...
setup(
    ...
    url='https://github.com/Manukumar-N/django-flat-json-widget',
    download_url='https://github.com/Manukumar-N/django-flat-json-widget/releases',
    ...
    extras_require={
        'test': [
            'openwisp-utils[qa] @ '
            'https://github.com/Manukumar-N/openwisp-utils/tarball/master',
